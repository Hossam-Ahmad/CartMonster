...
class ManualPaymentMethodController extends Controller
{
    ...
    public function submit_offline_payment(Request $request)
    {
        ...
        // if (IsyolSetting::where('type', 'category_wise_commission')->first()->value != 1) {
        //     $commission_percentage = IsyolSetting::where('type', 'vendor_commission')->first()->value;
