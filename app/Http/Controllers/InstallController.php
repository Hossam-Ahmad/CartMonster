...
class InstallController extends Controller
{
    ...
    {
        $IsyolSetting = IsyolSetting::where('type', 'system_default_currency')->first();
        $IsyolSetting->value = $request->system_default_currency;
        $IsyolSetting->save();

        $IsyolSetting = IsyolSetting::where('type', 'home_default_currency')->first();
        $IsyolSetting->value = $request->system_default_currency;
        $IsyolSetting->save();
