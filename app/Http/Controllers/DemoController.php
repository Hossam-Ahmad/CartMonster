...
class DemoController extends Controller
{
    ...
    public function convert_assets(Request $request)
    {
        ...
        $isyol_setting = IsyolSetting::where('type', 'home_slider_images')->first();
        $isyol_setting->value = json_encode(Slider::pluck('photo')->toArray());
        $isyol_setting->save();

        $isyol_setting = IsyolSetting::where('type', 'home_slider_links')->first();
        $isyol_setting->value = json_encode(Slider::pluck('link')->toArray());
        $isyol_setting->save();

        $isyol_setting = IsyolSetting::where('type', 'home_slider_images_two')->first();
        $isyol_setting->value = json_encode(Slider::pluck('photo')->toArray());
        $isyol_setting->save();

        $isyol_setting = IsyolSetting::where('type', 'home_slider_links_two')->first();
        $isyol_setting->value = json_encode(Slider::pluck('link')->toArray());
        $isyol_setting->save();

        $isyol_setting = IsyolSetting::where('type', 'home_banner1_images')->first();
        $isyol_setting->value = json_encode(Banner::where('position', 1)->pluck('photo')->toArray());
        $isyol_setting->save();

        $isyol_setting = IsyolSetting::where('type', 'home_banner1_links')->first();
        $isyol_setting->value = json_encode(Banner::where('position', 1)->pluck('url')->toArray());
        $isyol_setting->save();

        $isyol_setting = IsyolSetting::where('type', 'home_banner2_images')->first();
        $isyol_setting->value = json_encode(Banner::where('position', 2)->pluck('photo')->toArray());
        $isyol_setting->save();

        $isyol_setting = IsyolSetting::where('type', 'home_banner2_links')->first();
        $isyol_setting->value = json_encode(Banner::where('position', 2)->pluck('url')->toArray());
        $isyol_setting->save();

        $isyol_setting = IsyolSetting::where('type', 'home_categories')->first();
        $isyol_setting->value = json_encode(HomeCategory::pluck('category_id')->toArray());
        $isyol_setting->save();

        $isyol_setting = IsyolSetting::where('type', 'top10_categories')->first();
        $isyol_setting->value = json_encode(Category::where('top', 1)->pluck('id')->toArray());
        $isyol_setting->save();

        $isyol_setting = IsyolSetting::where('type', 'top10_brands')->first();
        $isyol_setting->value = json_encode(Brand::where('top', 1)->pluck('id')->toArray());
        $isyol_setting->save();
