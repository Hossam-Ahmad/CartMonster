...
<head>
    ...
    @endif
    <link rel="stylesheet" href="{{ static_asset('assets/css/by-isyol-marketplace-com-seller.css') }}">
        ...
        <div class="aiz-content-wrapper">
            ...
            <div class="aiz-main-content">
                ...
                <div class="bg-white text-center py-3 px-15px px-lg-25px mt-auto border-sm-top">
                    <p class="mb-0"><a href="https://isyol.com" target="_blank">BY ISYOL </a> | &copy;
                        {{ get_setting('site_name') }}</a></p>
                </div>
