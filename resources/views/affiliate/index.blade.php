                    ...
                    <form class="form-horizontal" action="{{ route('affiliate.store') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                ...
                                @endphp
                                <input type="number" min="0" step="0.01" max="100" class="form-control"
                                    name="percentage" value="{{ $percentage }}" placeholder="Percentage of Order Amount"
                                    required>
                            </div>
                            <div class="col-lg-2">
                ...
                <div class="card-body">
                    <form action="{{ route('affiliate.store') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <label
                                class="col-lg-3 col-from-label">{{ translate('Product Sharing and Purchasing') }}</label>
                            <div class="col-lg-6">
                                @php
                    ...
                    <form class="form-horizontal" action="{{ route('affiliate.store') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input value="1" name="status" type="checkbox"
                                        @if ($category_wise_affiliate_status) checked @endif>
                                    <span class="slider round"></span>
                                </label>
                            </div>
                        </div>
                        @if (\App\Models\AffiliateOption::where('type', 'category_wise_affiliate')->first() != null)
                            ...
                            @foreach (\App\Models\Category::all() as $key => $category)
                                ...
                                @if ($found)
                                    <div class="form-group row">
                                        <div class="col-lg-5">
                                            <input type="hidden" name="categories_id_{{ $value->category_id }}"
                                                value="{{ $value->category_id }}">
                                            <input type="text" class="form-control"
                                                value="{{ \App\Models\Category::find($value->category_id)->name }}"
                                                readonly>
                                        </div>
                                        <div class="col-lg-4">
                                        ...
                                        <div class="col-md-3">
                                            <select class="form-control aiz-selectpicker"
                                                ...
                                                <option value="amount" @if ($value->commission_type == 'amount') selected @endif>$
                                                </option>
                                                <option value="percent" @if ($value->commission_type == 'percent') selected @endif>
                                                    %</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-5">
                                            <input type="hidden" name="categories_id_{{ $category->id }}"
                                                value="{{ $category->id }}">
                                            <input type="text" class="form-control"
                                                value="{{ $category->getTranslation('name') }}" readonly>
                                        </div>
                                        <div class="col-lg-4">
                                            <input type="number" min="0" step="0.01" class="form-control"
                            ...
                            <div class="col-lg-8">
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" placeholder="No of Days"
                                        name="validation_time" value="{{ $validation_time }}">
