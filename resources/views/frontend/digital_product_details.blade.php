                        ...
                        <div class="text-left">
                            ...
                            @if (addon_is_activated('club_point') && $detailedProduct->earn_point > 0)
                                <div class="row no-gutters mt-4">
                                    <div class="col-2">
                                        <div class="opacity-50">{{ translate('Product Point') }}:</div>
                                    </div>
                                    <div class="col-10">
                            ...
                            <div class="mt-3">
                                <button type="button" class="btn btn-primary mr-2 add-to-cart fw-600"
                                    onclick="addToCart()">
                                    <i class="las la-shopping-bag"></i>
                                    <span class="d-none d-md-inline-block"> {{ translate('Add to cart') }}</span>
                                </button>
                                <button type="button" class="btn btn-info buy-now fw-600" onclick="buyNow()">
                                            ...
                                            @if ($review->user != null)
                                                <li class="media list-group-item d-flex">
                                                    ...
                                                    <span class="avatar avatar-md mr-3">
                                                        ...
                                                        @else
                                                            data-src="{{ uploaded_asset('assets/img/isyol-placeholder.png') }}" @endif>
                                                    </span>
