<div class="aiz-card-box border border-light rounded hov-shadow-md mt-1 mb-2 has-transition bg-white">
    ...
    <div class="position-relative">
        ...
        @if ($product->wholesale_product)
            <span class="absolute-bottom-left fs-11 text-white fw-600 px-2 lh-1-8" style="background-color: #181818">
                {{ translate('Wholesale') }}
            </span>
        @endif
    ...
    <div class="p-md-3 p-2 text-left">
        <div class="fs-15">
            ...
            @endif
            <span class="fw-700 text-dark">{{ home_discounted_base_price($product) }}</span>
        </div>
        ...
        @if (addon_is_activated('club_point'))
            <div class="rounded px-2 mt-2 bg-light border-light border">
