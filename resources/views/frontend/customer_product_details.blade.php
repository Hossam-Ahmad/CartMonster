...
@section('meta')
    ...
    <meta itemprop="name" content="{{ $customer_product->getTranslation('meta_title') }}">
    <meta itemprop="description" content="{{ $customer_product->getTranslation('meta_description') }}">
    ...
    <meta name="twitter:title" content="{{ $customer_product->getTranslation('meta_title') }}">
    <meta name="twitter:description" content="{{ $customer_product->getTranslation('meta_description') }}">
    ...
    <!-- Open Graph data -->
    <meta property="og:title" content="{{ $customer_product->getTranslation('meta_title') }}" />
    ...
    <meta property="og:description" content="{{ $customer_product->getTranslation('meta_description') }}" />
                    ...
                    <div class="col-xl-7 col-lg-6">
                        <div class="text-left">
                            ...
                            <div class="row no-gutters mt-5">
                                ...
                                <div class="col-10">
                                    <div class="aiz-share" dir="ltr"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="p-4">
                            <div class="embed-responsive embed-responsive-16by9 mb-5">
                                ...
                                @elseif ($customer_product->video_provider == 'dailymotion' &&
                                    isset(explode('video/', $customer_product->video_link)[1]))
                                    <iframe class="embed-responsive-item"
                                ...
                                @elseif ($customer_product->video_provider == 'vimeo' &&
                                    isset(explode('vimeo.com/', $customer_product->video_link)[1]))
                                    <iframe
            ...
            <div class="bg-white shadow-sm rounded">
                ...
                <div class="p-3">
                    <div class="aiz-carousel gutters-5 half-outside-arrow" data-items="6" data-xl-items="5"
                        ...
                        data-infinite='true'>
                        @php
                            $products = \App\Models\CustomerProduct::where('category_id', $customer_product->category_id)
                                ->where('id', '!=', $customer_product->id)
                                ->where('status', '1')
                                ->where('published', '1')
                                ->limit(10)
                                ->get();
