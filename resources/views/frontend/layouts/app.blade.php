...
<head>
    ...
    ?>
    <meta rel="canonical" href="<?php echo $canonical; ?>" />
    <title>@yield('meta_title', get_setting('website_name', null, app()->getLocale()) . ' | ' . get_setting('site_motto', null, app()->getLocale()))</title>
    ...
    <meta name="description" content="@yield('meta_description', get_setting('meta_description', null, app()->getLocale()))" />
    <meta name="keywords" content="@yield('meta_keywords', get_setting('meta_keywords', null, app()->getLocale()))">
    @yield('meta')
    @if (!isset($detailedProduct) && !isset($customer_product) && !isset($shop) && !isset($page) && !isset($blog))
        <meta itemprop="name" content="{{ get_setting('meta_title', null, app()->getLocale()) }}">
        <meta itemprop="description" content="{{ get_setting('meta_description', null, app()->getLocale()) }}">
        <meta itemprop="image" content="{{ uploaded_asset(get_setting('meta_image', null, app()->getLocale())) }}">
        <meta name="twitter:card" content="product">
        <meta name="twitter:site" content="@isyolcom" />
        <meta name="author" content="RAGIP MULLAMUSA">
        <meta name="twitter:title" content="{{ get_setting('meta_title', null, app()->getLocale()) }}">
        <meta name="twitter:description" content="{{ get_setting('meta_description', null, app()->getLocale()) }}">
        <meta name="twitter:creator" content="@isyolcom">
        <meta name="twitter:image" content="{{ uploaded_asset(get_setting('meta_image', null, app()->getLocale())) }}">
        <meta property="og:title" content="{{ get_setting('meta_title', null, app()->getLocale()) }}" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="{{ route('home') }}" />
        <meta property="og:image"
            content="{{ uploaded_asset(get_setting('meta_image', null, app()->getLocale())) }}" />
        <meta property="og:description" content="{{ get_setting('meta_description', null, app()->getLocale()) }}" />
...
<body>
    <div class="aiz-main-wrapper d-flex flex-column">
        <h1 style="display:none">
            {{ translate('ISYOL platform is the largest platform that brings together all Turkish and Arab products in Turkey, wholesale and retail, with a fast shipping service to all countries of the world') }}
        </h1>
                ...
                $.post('{{ route('search.ajax') }}', {
                    ...
                    if (data == '0') {
                        ...
                        $('.typed-search-box .search-nothing').removeClass('d-none').html(
                            'Sorry, nothing found for <b>"' + searchKey + '"</b>');
