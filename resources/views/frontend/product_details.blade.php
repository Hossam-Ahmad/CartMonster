                        ...
                        <div class="text-left">
                            ...
                            @if (addon_is_activated('club_point') && $detailedProduct->earn_point > 0)
                                <div class="row no-gutters mt-4">
                                    <div class="col-sm-2">
                                        <div class="opacity-50 my-2">{{ translate('Product Point') }}:</div>
                                    </div>
                                    <div class="col-sm-10">
                                        <div
                            ...
                            <div class="mt-3">
                                ...
                                @else
                                    <button type="button" class="btn btn-info mr-2 add-to-cart fw-600"
                                        onclick="addToCart()">
                                        <i class="las la-shopping-bag"></i>
                                        <span class="d-none d-md-inline-block"> {{ translate('Add to cart') }}</span>
                                    </button>
                                    <button type="button" class="btn btn-success buy-now fw-600" onclick="buyNow()">
                                ...
                                <div class="row no-gutters mt-3">
                                    ...
                                    <div class="col-10">
                                        <a href="{{ route('returnpolicy') }}" target="_blank">
                                            ...
                                            @else
                                                <img src="{{ static_asset('assets/img/isyol-logo.png') }}"
                                                    height="36">
                                            @endif
                                        </a>
                    ...
                    @if ($detailedProduct->added_by == 'seller' && $detailedProduct->user->shop != null)
                        <div class="bg-white shadow-sm mb-3">
                            ...
                            <div class="row no-gutters align-items-center border-top">
                                <div class="col">
                                    <a href="{{ route('shop.visit', $detailedProduct->user->shop->slug) }}"
                                        class="d-block btn btn-primary rounded-0">{{ translate('Visit Store') }}</a>
                                </div>
                                <div class="col">
                                            ...
                                            @if ($review->user != null)
                                                <li class="media list-group-item d-flex">
                                                    <span class="avatar avatar-md mr-3">
                                                        ...
                                                        @else
                                                            data-src="{{ static_asset('assets/img/isyol-placeholder.png') }}" @endif>
                                                    </span>
                                        ...
                                        @foreach ($own_product_queries as $product_query)
                                            <div class="produc-queries border-bottom">
                                                <div class="query d-flex my-4">
                                                    <span class="mt-1"><svg xmlns="http://www.w3.org/2000/svg"
                                                            width="24.994" height="24.981" viewBox="0 0 24.994 24.981">
                                                    ...
                                                    <div class="ml-3">
                                                        <div class="fs-14">{{ strip_tags($product_query->question) }}
                                                        </div>
                                                        <span class="text-secondary">{{ $product_query->user->name }}
                                                        </span>
                                                    </div>
                                                </div>
                                                <div class="answer d-flex my-4">
                                                    <span class="mt-1"> <svg xmlns="http://www.w3.org/2000/svg"
                                                            width="24.99" height="24.98" viewBox="0 0 24.99 24.98">
