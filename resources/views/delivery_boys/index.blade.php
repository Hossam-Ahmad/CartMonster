...
@section('content')
    <div class="aiz-titlebar text-left mt-2 mb-3">
        <div class="row align-items-center">
            <div class="col-auto">
                <h1 class="h3 text-light">{{ translate('All Delivery Boys') }}</h1>
            </div>
                        ...
                        @if ($delivery_boy->user != null)
                            <tr>
                                ...
                                <td>
                                    <div class="dropdown">
                                        <button type="button"
                                            class="btn btn-sm btn-circle btn-primary btn-icon dropdown-toggle no-arrow"
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-xs">
                                            ...
                                            @endif
                                            <a href="#"
                                                onclick="show_order_collection_modal('{{ $delivery_boy->user->id }}');"
                                                class="dropdown-item">
                                                {{ translate('Go to Collection') }}
                                            </a>
                                            <a href="#"
                                                onclick="show_delivery_earning_modal('{{ $delivery_boy->user->id }}');"
                                                class="dropdown-item">
                                    ...
                                    {{-- <a href="{{route('delivery_boys.login', encrypt($delivery_boy->user->id))}}" class="btn btn-primary btn-icon btn-circle btn-sm" title="{{ translate('Log in as this delivery_boy') }}">
