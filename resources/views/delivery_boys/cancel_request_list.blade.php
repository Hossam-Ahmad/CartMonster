...
@section('content')
    <div class="aiz-titlebar text-left mt-2 mb-3">
        <div class="row align-items-center">
            <div class="col-auto">
                <h1 class="h3 text-light">{{ translate('All Cancel Request') }}</h1>
            </div>
        </div>
    </div>
                    ...
                    @foreach ($cancel_requests as $key => $cancel_request)
                        <tr>
                            ...
                            <td class="text-right">
                                ...
                                <a href="{{ route('all_orders.show', encrypt($cancel_request->id)) }}"
                                    class="btn btn-soft-info btn-icon btn-circle btn-sm" title="{{ translate('View') }}">
