                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a class="btn btn-primary btn-icon btn-circle btn-sm"
                                            href="{{ route('product_club_point.edit', encrypt($product->id)) }}"
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{ route('set_products_point.store') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="number" min="0" step="0.01" class="form-control" name="point"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="number" min="0" step="0.01" class="form-control" name="min_price"
                                    value="{{ \App\Models\Product::min('unit_price') }}" placeholder="50" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <input type="number" min="0" step="0.01" class="form-control" name="max_price"
                                    value="{{ \App\Models\Product::max('unit_price') }}" placeholder="110" required>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('set_all_products_point.store') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="number" step="0.001" class="form-control" name="point" placeholder="1"
                                    required>
                            </div>
                            <div class="col-lg-2">
