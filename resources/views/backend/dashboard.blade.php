...
@section('content')
        ...
        <div class="row gutters-10">
                        ...
                        <div class="bg-grad-2 text-white rounded-lg mb-4 overflow-hidden">
                            <div class="px-3 pt-3">
                                <div class="opacity-50">
                                    <span class="fs-12">{{ translate('Total') }}</span>
                                    {{ translate('Customer') }}
                                </div>
                                <div class="h3 fw-700 mb-3 text-light">
                                    {{ \App\Models\User::where('user_type', 'customer')->where('email_verified_at', '!=', null)->count() }}
                                </div>
                            </div>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                                <path fill="#303030" fill-opacity="1"
            ...
            <div class="col-lg-12">
                @if (Auth::user()->user_type == 'admin' || in_array('25', json_decode(Auth::user()->staff->role->permissions)))
                    <div class="row gutters-10">
                        <div class="col-md-6">
                            <div class="card card bg-black border-dark">
                                <div class="card-header bg-black border-dark">
                                    <h6 class="mb-0 fs-14 text-light">{{ translate('Category wise product sale') }}</h6>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="card card bg-black border-dark">
                                <div class="card-header bg-black border-dark">
                                    <h6 class="mb-0 fs-14 text-light">{{ translate('Category wise product stock') }}</h6>
                                </div>
                                <div class="card-body">
                ...
                <div class="row gutters-10">
                    <div class="col-6">
                        <div class="card bg-black border-dark">
                            <div class="card-header bg-black border-dark">
                                <h6 class="mb-0 fs-14 text-light">{{ translate('Products') }}</h6>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-6">
                        <div class="card bg-black border-dark">
                            <div class="card-header bg-black border-dark">
                                <h6 class="mb-0 fs-14 text-light">{{ translate('Sellers') }}</h6>
                            </div>
                            <div class="card-body">
    ...
    <div class="card bg-black border-dark">
        <div class="card-header bg-black border-dark">
            <h6 class="mb-0 text-light">{{ translate('Top 20 Products') }}</h6>
        </div>
        <div class="card-body">
                ...
                @foreach (filter_products(\App\Models\Product::where('published', 1)->orderBy('num_of_sale', 'desc'))->limit(20)->get() as $key => $product)
                    <div class="carousel-box">
                        <div
                            ...
                            <div class="p-md-3 p-2 text-left bg-black">
                                <div class="fs-15">
                                    @if (home_base_price($product) != home_discounted_base_price($product))
                                        <del
                                            class="fw-600 opacity-50 mr-1 text-light">{{ home_base_price($product) }}</del>
                                    @endif
                                    <span class="fw-700 text-light">{{ home_discounted_base_price($product) }}</span>
                                </div>
                                ...
                                <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0">
                                    <a href="{{ route('product', $product->slug) }}"
                                        class="d-block text-light">{{ $product->getTranslation('name') }}</a>
                                </h3>
                            </div>
                        </div>
                    </div>
