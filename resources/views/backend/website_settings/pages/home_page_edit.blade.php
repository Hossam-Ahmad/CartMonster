    ...
    <div class="row">
        <div class="col-xl-10 mx-auto">
            ...
            <div class="col-lg-12 mx-auto bg-white">
                <ul class="nav nav-fill border-bu">
                    @foreach (\App\Models\Language::all() as $key => $language)
                        <li class="nav-item bu">
                            <a class="nav-link text-reset py-3"
                                @if ($language->code == $lang) style="background:#e0e0e0" @endif
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('isyol_settings.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            ...
                            <div class="home-slider-target">
                                ...
                                @if (get_setting('home_slider_images') != null)
                                    @foreach (json_decode(get_setting('home_slider_images', null, $lang), true) as $key => $value)
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group" data-toggle="aizuploader" data-type="image">
                                                        ...
                                                        <input type="hidden" name="home_slider_images[]"
                                                            ...
                                                            value="{{ json_decode(get_setting('home_slider_images', null, $lang), true)[$key] }}">
                                                    </div>
                                            ...
                                            <div class="col-md">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="http://"
                                                        ...
                                                        value="{{ json_decode(get_setting('home_slider_links', null, $lang), true)[$key] }}">
                                                </div>
                                            </div>
                    ...
                    <form action="{{ route('isyol_settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="home-banner1-target">
                                ...
                                @if (get_setting('home_banner1_images', null, $lang) != null)
                                    @foreach (json_decode(get_setting('home_banner1_images', null, $lang), true) as $key => $value)
                                        <div class="row gutters-5">
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <div class="input-group" data-toggle="aizuploader" data-type="image">
                                                        ...
                                                        <input type="hidden" name="home_banner1_images[]"
                                                            class="selected-files"
                                                            value="{{ json_decode(get_setting('home_banner1_images', null, $lang), true)[$key] }}">
                                                    </div>
                                                    <div class="file-preview box sm">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="http://"
                                                        ...
                                                        value="{{ json_decode(get_setting('home_banner1_links', null, $lang), true)[$key] }}">
                                                </div>
                                            </div>
                                            <div class="col-md-auto">
                                                <div class="form-group">
                    ...
                    <form action="{{ route('isyol_settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="home-banner2-target">
                                ...
                                @if (get_setting('home_banner2_images', null, $lang) != null)
                                    @foreach (json_decode(get_setting('home_banner2_images', null, $lang), true) as $key => $value)
                                        <div class="row gutters-5">
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <div class="input-group" data-toggle="aizuploader" data-type="image">
                                                        ...
                                                        <input type="hidden" name="home_banner2_images[]"
                                                            class="selected-files"
                                                            value="{{ json_decode(get_setting('home_banner2_images', null, $lang), true)[$key] }}">
                                                    </div>
                                                    <div class="file-preview box sm">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="http://"
                                                        ...
                                                        value="{{ json_decode(get_setting('home_banner2_links', null, $lang), true)[$key] }}">
                                                </div>
                                            </div>
                                            <div class="col-md-auto">
                                                <div class="form-group">
                    ...
                    <form action="{{ route('isyol_settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="home-banner3-target">
                                ...
                                @if (get_setting('home_banner3_images', null, $lang) != null)
                                    @foreach (json_decode(get_setting('home_banner3_images', null, $lang), true) as $key => $value)
                                        <div class="row gutters-5">
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <div class="input-group" data-toggle="aizuploader" data-type="image">
                                                        ...
                                                        <input type="hidden" name="home_banner3_images[]"
                                                            class="selected-files"
                                                            value="{{ json_decode(get_setting('home_banner3_images', null, $lang), true)[$key] }}">
                                                    </div>
                                                    <div class="file-preview box sm">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="http://"
                                                        ...
                                                        value="{{ json_decode(get_setting('home_banner3_links', null, $lang), true)[$key] }}">
                                                </div>
                                            </div>
                                            <div class="col-md-auto">
                                                <div class="form-group">
