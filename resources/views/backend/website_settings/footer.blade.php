...
@section('content')
    ...
    <div class="aiz-titlebar text-left mt-2 mb-3">
        <div class="row align-items-center">
            <div class="col">
                <h1 class="h3 text-white">{{ translate('Website Footer') }}</h1>
            </div>
        </div>
    </div>
    <ul class="nav nav-tabs nav-fill border-light bg-light">
                    ...
                    <div class="card shadow-none bg-light">
                        ...
                        <div class="card-body">
                            <form action="{{ route('isyol_settings.update') }}" method="POST"
                                ...
                                <div class="form-group">
                                    <label>{{ translate('App Gallery Link') }}</label>
                                    <input type="hidden" name="types[]" value="app_gallery_link">
                                    <input type="text" class="form-control" placeholder="http://" name="app_gallery_link"
                                        value="{{ get_setting('app_gallery_link') }}">
                                </div>
                                <div class="form-group">
