                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    ...
                                    <input value="1" name="minimum_order_amount_check" type="checkbox"
                                        @if (get_setting('minimum_order_amount_check') == 1) checked @endif>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="minimum_order_amount"
                                    value="{{ get_setting('minimum_order_amount') }}"
