...
@section('content')
    <div class="aiz-titlebar text-left mt-2 mb-3">
        <div class="row align-items-center">
            <div class="col-md-6">
                <h1 class="h3 text-light">{{ translate('All Currencies') }}</h1>
            </div>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <a class="btn btn-primary btn-icon btn-circle btn-sm"
                                    onclick="edit_currency_modal('{{ $currency->id }}');" title="{{ translate('Edit') }}">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('isyol_settings.update') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <select class="form-control aiz-selectpicker" name="no_of_decimals">
                                    ...
                                    <option value="1" @if (get_setting('no_of_decimals') == 1) selected @endif>1234.5
                                    </option>
                                    <option value="2" @if (get_setting('no_of_decimals') == 2) selected @endif>123.45
                                    </option>
                                    <option value="3" @if (get_setting('no_of_decimals') == 3) selected @endif>12.345
                                    </option>
                                </select>
                            </div>
                        </div>
