...
@section('content')
    <h4 class="text-center text-white mt-4">{{ translate('System') }}</h4>
    <div class="row">
        <div class="col-lg-4">
            <div class="card">
    ...
    <hr />
    <h4 class="text-center text-white mt-4">{{ translate('Business Related') }}</h4>
    <div class="row">
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                ...
                <div class="card-body text-center">
                    <label class="aiz-switch aiz-switch-success mb-0">
                        <input type="checkbox" onchange="updateSettings(this, 'product_manage_by_admin')"
                            <?php if (\App\Models\isyolSetting::where('type', 'product_manage_by_admin')->first() && get_setting('product_manage_by_admin') == 1) {
                                echo 'checked';
                            } ?>>
                        <span class="slider round"></span>
                    </label>
                ...
                <div class="card-body text-center">
                    <label class="aiz-switch aiz-switch-success mb-0">
                        <input type="checkbox" onchange="updateSettings(this, 'product_approve_by_admin')"
                            <?php if (\App\Models\isyolSetting::where('type', 'product_approve_by_admin')->first() && get_setting('product_approve_by_admin') == 1) {
                                echo 'checked';
                            } ?>>
                        <span class="slider round"></span>
                    </label>
    ...
    <hr />
    <h4 class="text-center text-white mt-4">{{ translate('Payment Related') }}</h4>
    <div class="row">
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header text-center bord-btm">
                    <h6 class="mb-0 h6 text-center">{{ translate('Paypal Payment Activation') }}</h6>
                </div>
                <div class="card-body">
                    <div class="clearfix">
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header">
                    <h6 class="mb-0 h6 text-center">{{ translate('Stripe Payment Activation') }}</h6>
                </div>
                <div class="card-body text-center">
                    <div class="clearfix">
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header">
                    <h6 class="mb-0 h6 text-center">{{ translate('Iyzico Activation') }}</h6>
                </div>
                <div class="card-body text-center">
                    <div class="clearfix">
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header">
                    <h6 class="mb-0 h6 text-center">{{ translate('Cash Payment Activation') }}</h6>
                </div>
                <div class="card-body text-center">
                    <div class="clearfix">
    ...
    <hr />
    <h4 class="text-center text-white mt-4">{{ translate('Social Media Login') }}</h4>
    <div class="row">
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header">
                ...
                <div class="card-body">
                    <div class="clearfix">
                        <img class="float-left" src="{{ static_asset('assets/img/social/facebook.png') }}"
                            height="30">
                        <label class="aiz-switch aiz-switch-success mb-0 float-right">
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="clearfix">
                        <img class="float-left" src="{{ static_asset('assets/img/social/google.png') }}" height="30">
                        <label class="aiz-switch aiz-switch-success mb-0 float-right">
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="clearfix">
                        <img class="float-left" src="{{ static_asset('assets/img/social/twitter.png') }}"
                            height="30">
                        <label class="aiz-switch aiz-switch-success mb-0 float-right">
...
@section('script')
    <script type="text/javascript">
        function updateSettings(el, type) {
            ...
            $.post('{{ route('isyol_settings.update.activation') }}', {
                _token: '{{ csrf_token() }}',
                type: type,
                value: value
            }, function(data) {
