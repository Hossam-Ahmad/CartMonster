            ...
            <table class="table aiz-table mb-0">
                <thead>
                    <tr>
                        ...
                        <th class="text-right" width="25%">{{ translate('Options') }}</th>
                    </tr>
                </thead>
                <tbody>
                    @php
                    ...
                    @foreach ($languages as $key => $language)
                        <tr>
                            ...
                            <td class="text-right">
                                ...
                                <a class="btn btn-warning btn-icon btn-circle btn-sm"
                                ...
                                <a class="btn btn-primary btn-icon btn-circle btn-sm"
                                    href="{{ route('languages.edit', $language->id) }}" title="{{ translate('Edit') }}">
