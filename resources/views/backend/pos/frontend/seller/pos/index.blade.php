                    ...
                    <div class="col-md">
                        ...
                        <div class="aiz-pos-product-list c-scrollbar-light">
                            ...
                            <div id="load-more" class="text-center">
                                <div class="fs-14 d-inline-block fw-600 btn btn-primary c-pointer"
                                                ...
                                                @forelse (Session::get('pos.cart') as $key => $cartItem)
                                                    ...
                                                    <li class="list-group-item py-0 pl-2">
                                                        <div class="row gutters-5 align-items-center">
                                                            ...
                                                            <div class="col">
                                                                <div class="text-truncate-2">{{ $stock->product->name }}
                                                                </div>
                                                                <span
                                        ...
                                        <div class="dropdown-menu p-3 dropdown-menu-lg">
                                            <div class="input-group">
                                                <input type="number" min="0" placeholder="Amount"
                                                    ...
                                                    value="{{ Session::get('pos.shipping', 0) }}" required
                                        ...
                                        <div class="dropdown-menu p-3 dropdown-menu-lg">
                                            <div class="input-group">
                                                <input type="number" min="0" placeholder="Amount"
                                                    ...
                                                    value="{{ Session::get('pos.discount', 0) }}" required
