...
@section('content')
    <div class="aiz-titlebar text-left mt-2 mb-3">
        <h5 class="mb-0 h6 text-light">{{ translate('Brand Information') }}</h5>
    </div>
            ...
            <div class="card-body p-0">
                ...
                <form class="p-4" action="{{ route('brands.update', $brand->id) }}" method="POST"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="meta_title"
                                value="{{ $brand->getTranslation('meta_title', $lang) }}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea name="meta_description" rows="8" class="form-control">{{ $brand->getTranslation('meta_description', $lang) }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
