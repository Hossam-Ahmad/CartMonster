...
@section('content')
    <div class="aiz-titlebar text-left mt-2 mb-3">
        <h1 class="mb-0 h6 text-white">{{ translate('Edit Product') }}</h5>
    </div>
    <div class="">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <br>
                            <div style="overflow: scroll; max-height:400px;" class="bg-light">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" name="meta_title"
                                        value="{{ $product->getTranslation('meta_title', $lang) }}"
