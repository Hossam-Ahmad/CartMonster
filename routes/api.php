...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function () {
    ...
    Route::apiResource('business-settings', 'App\Http\Controllers\Api\V2\IsyolSettingController')->only('index');
    ...
    Route::post('business-settings', 'App\Http\Controllers\Api\V2\ConfigController@isyol_settings');
    //Pickup Point list
