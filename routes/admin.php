...
use App\Http\Controllers\IsyolSettingsController;
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    // Business Settings
    Route::controller(IsyolSettingsController::class)->group(function () {
        Route::post('/business-settings/update', 'update')->name('isyol_settings.update');
        Route::post('/business-settings/update/activation', 'updateActivationSettings')->name('isyol_settings.update.activation');
        ...
        Route::get('/vendor_commission', 'vendor_commission')->name('isyol_settings.vendor_commission');
        Route::post('/vendor_commission_update', 'vendor_commission_update')->name('isyol_settings.vendor_commission.update');
